...
output_3 <- getOptionValue("--galaxy_output3")
...
# Vérification du nombre de threads spécifié
if (thread_param > 1) {
    # Chargement de la bibliothèque BiocParallel
    library(BiocParallel)
    
    # Enregistrement de la configuration de parallélisation
    BiocParallel::register(BiocParallel::MulticoreParam(thread_param))

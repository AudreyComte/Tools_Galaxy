...
# Créer une fonction logique pour vérifier si les lignes remplissent les conditions
row_meets_conditions <- function(row, param1, param2) {
  sum(row[-1] >= param1) >= param2
}

# Appliquer la fonction à chaque ligne du dataframe
df_cpm_filter <- df_cpm[apply(df_cpm, 1, row_meets_conditions, param1, param2), ]

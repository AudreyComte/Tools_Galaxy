...
for (combo in condition_combinations) {
  ...
  write.table(df_cpm_filter, file = paste0(output_file2, "_", condition1, "_vs_", condition2), sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
  ...
  write.table(dataframe_filtered_count, file = paste0(output_file3, "_", condition1, "_vs_", condition2), sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
}

...
for (combo in condition_combinations) {
  ...
  file_name_out_put2 <- paste0(condition1, "_vs_cpm_", condition2, ".tabular")
  write.table(df_cpm_filter, file_name_out_put2, sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
  ...
  file_name_out_put3 <- paste0(condition1, "_vs_count_", condition2, ".tabular")
  write.table(dataframe_filtered_count, file_name_out_put3, sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
}
